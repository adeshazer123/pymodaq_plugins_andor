# viewer plugin for the Kymera camera that focuses on taking an image 
import numpy as np
...
class DAQ_2DViewer_Andor(DAQ_Viewer_base):
    """
        Base class for Kymera camera and AndoriDus spectrometer
